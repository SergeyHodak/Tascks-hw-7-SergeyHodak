...
public class Test {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("-------------------------------------------");
        Shape infa1 = new Console().shape(); // вводим в консоль имя фигуры
        ...
        Shape infa2 = new StringR().stringR("Line"); // передаем сюда строку, указвывая одно из уже прописанных классов Line, Triangle, Polyhedron, Quad, Circle
        ...
        Shape infa3 = new SelectFromList().name("dddd");//выбираем готовую вигуру спользуя одно из имен классов Line, Triangle, Polyhedron, Quad, Circle
